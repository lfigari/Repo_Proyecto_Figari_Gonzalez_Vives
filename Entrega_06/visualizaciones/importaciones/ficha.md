## FICHA TÉCNICA VIVES
Fuente de los datos: Tablas elaboradas a partir de registros de importación de pistachos, la almendra, la avellana, la castaña y la nuez en Chile según datos entregados por el Servicio Nacional de Aduanas, y medido desde valores en dólares CIF, es decir, costo, seguro y flete incluidos
...
Alcance de los datos: Hay meses y acumulaciones de años con valores nulos que significa que no hubo importación ese mes. 
